...
def populate_guest_assignments(guest_id):
    ...
    try:
        ...
        Enrollment.enroll_student(Class.get_class_id_by_class_name("guest class"), guest_id)
        Enrollment.enroll_student(Class.get_class_id_by_class_name("guest class 2"), guest_id)
        prof_id = Professor.get_professor_id_by_professor_name("guest professor")
        print("got prof_id",flush=True)
        class_id = Class.get_class_id_by_class_name("guest class")
        class2_id = Class.get_class_id_by_class_name("guest class 2")
        ...
        Assignment.post_assignment(guest_id, case_study2_id, None)
        print("Made 5 assignments",flush=True)
        ...
        print(f"assignment ids : {empty_assignment.id} {half_assignment.id} {done_assignment.id}", flush=True)
