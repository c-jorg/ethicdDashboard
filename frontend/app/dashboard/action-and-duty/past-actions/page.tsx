...
import DutiesVersusActionsForm from '@/app/ui/dashboard/action-and-duty/duties-versus-actions-form';
...
export default function DutiesVersusActionsPage() {
